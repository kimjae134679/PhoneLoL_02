...
namespace GooglePlayGames.Native.PInvoke
{
	internal class NativeTurnBasedMatch : BaseReferenceHolder
	{
		...
		{
			return GooglePlayGames.Native.Cwrapper.TurnBasedMatch.TurnBasedMatch_HasRematchId(SelfPtr());
		}
		...
		internal byte[] Data()
		{
			...
			return PInvokeUtilities.OutParamsToBytes((byte[] bytes, UIntPtr size) => GooglePlayGames.Native.Cwrapper.TurnBasedMatch.TurnBasedMatch_Data(SelfPtr(), bytes, size));
		}

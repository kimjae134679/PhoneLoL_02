	...
	internal class SnapshotManager
	{
		...
		internal class ReadResponse : BaseReferenceHolder
		{
			...
			internal byte[] Data()
			{
				...
				return PInvokeUtilities.OutParamsToBytes((byte[] out_bytes, UIntPtr out_size) => GooglePlayGames.Native.Cwrapper.SnapshotManager.SnapshotManager_ReadResponse_GetData(SelfPtr(), out_bytes, out_size));
			}

...
{
    [MenuItem("PhoneLOL/Export 1.7.2 iOS Xcode project")]
    public static void BuildIOSCandidate()
    {
        ...
        PlayerSettings.iOS.buildNumber = "199";
        ...
        string output = Path.GetFullPath("Builds/iOS/PhoneLOL-1.7.2");
    ...
    [MenuItem("PhoneLOL/Build 1.7.2 ARM64 candidate")]
    public static void BuildAndroidCandidate()
    {
        ...
        PlayerSettings.bundleVersion = "1.7.2";
        PlayerSettings.Android.bundleVersionCode = 199;
...
UnityEditor.PlayerSettings.allowedAutorotateToLandscapeRight = true;
        ...
        string output = Path.GetFullPath("Builds/PhoneLOL-1.7.2.apk");
        Directory.CreateDirectory(Path.GetDirectoryName(output));
        var report = BuildPipeline.BuildPlayer(new BuildPlayerOptions {
